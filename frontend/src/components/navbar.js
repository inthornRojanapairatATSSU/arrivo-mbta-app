...
import { Container, Nav, NavDropdown, Button, Modal } from 'react-bootstrap';
...
export default function Navbar() {
  ...
  // it seems.
  // placeholder: <ReactNavbar.Brand href="/"><img src={MBTAlogo} height={30} width={30} alt="BigCo Inc. logo"/> ARRIVO</ReactNavbar.Brand>
  return (
